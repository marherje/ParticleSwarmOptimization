...
do
    for cat in catB #catB catC catD
    do
	python runPSO.py -c FlavourTag500IFIC_dEdx_configs/FlavourTag500IFIC_dEdx_${pol}_${cat}.txt -o FlavourTag500IFIC_dEdx_${pol}_${cat} > LogFlavourTag500IFIC_dEdx_${pol}_${cat}
    done
done
