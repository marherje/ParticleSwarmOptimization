  // Declaration of leaf types
   ...
   Int_t           mc_quark_ps_n;
   Float_t         mc_quark_ps_E[10000];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_px[10000];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_py[10000];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_pz[10000];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_m[10000];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_pdg[10000];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_charge[10000];   //[mc_quark_ps_n]
   ...
   Int_t           mc_stable_n;
   Float_t         mc_stable_E[10000];   //[mc_stable_n]
   Float_t         mc_stable_px[10000];   //[mc_stable_n]
   Float_t         mc_stable_py[10000];   //[mc_stable_n]
   Float_t         mc_stable_pz[10000];   //[mc_stable_n]
   Float_t         mc_stable_m[10000];   //[mc_stable_n]
   Int_t           mc_stable_pdg[10000];   //[mc_stable_n]
   Float_t         mc_stable_charge[10000];   //[mc_stable_n]
   Int_t           mc_stable_isoverlay[10000];   //[mc_stable_n]
   Int_t           mc_stable_isisr[10000];   //[mc_stable_n]
   ...
   Int_t           pfo_n_j2;
   Int_t           jet_nvtx_j2;
   Int_t           pfo_match[10000];   //[pfo_n]
   Int_t           pfo_truejet_pdg[10000];   //[pfo_n]
   Int_t           pfo_truejet_type[10000];   //[pfo_n]
   Int_t           pfo_pdgcheat[10000];   //[pfo_n]
   Float_t         pfo_E[10000];   //[pfo_n]
   Float_t         pfo_px[10000];   //[pfo_n]
   Float_t         pfo_py[10000];   //[pfo_n]
   Float_t         pfo_pz[10000];   //[pfo_n]
   Float_t         pfo_m[10000];   //[pfo_n]
   Int_t           pfo_type[10000];   //[pfo_n]
   Int_t           pfo_isoverlay[10000];   //[pfo_n]
   Int_t           pfo_isisr[10000];   //[pfo_n]
   Int_t           pfo_vtx[10000];   //[pfo_n]
   Int_t           pfo_charge[10000];   //[pfo_n]
   Int_t           pfo_ntracks[10000];   //[pfo_n]
   Int_t           pfo_tpc_hits[10000];   //[pfo_n]
   Float_t         pfo_dedx[10000];   //[pfo_n]
   Float_t         pfo_dedxerror[10000];   //[pfo_n]
   Float_t         pfo_d0[10000];   //[pfo_n]
   Float_t         pfo_d0error[10000];   //[pfo_n]
   Float_t         pfo_z0[10000];   //[pfo_n]
   Float_t         pfo_z0error[10000];   //[pfo_n]
   Float_t         pfo_phi[10000];   //[pfo_n]
   Float_t         pfo_phierror[10000];   //[pfo_n]
   Float_t         pfo_omega[10000];   //[pfo_n]
   Float_t         pfo_omegaerror[10000];   //[pfo_n]
   Float_t         pfo_tanlambda[10000];   //[pfo_n]
   Float_t         pfo_tanlambdaerror[10000];   //[pfo_n]
   Float_t         pfo_chi2[10000];   //[pfo_n]
   Float_t         pfo_ndf[10000];   //[pfo_n]
   Int_t           pfo_pid[10000];   //[pfo_n]
   Float_t         pfo_pid_likelihood[10000];   //[pfo_n]
   Float_t         pfo_pid_eprob[10000];   //[pfo_n]
   Float_t         pfo_pid_muprob[10000];   //[pfo_n]
   Float_t         pfo_pid_piprob[10000];   //[pfo_n]
   Float_t         pfo_pid_kprob[10000];   //[pfo_n]
   Float_t         pfo_pid_pprob[10000];   //[pfo_n]
   Float_t         pfo_pid_hprob[10000];   //[pfo_n]
   Int_t           pfo_piddedx[10000];   //[pfo_n]
   Float_t         pfo_piddedx_likelihood[10000];   //[pfo_n]
   Float_t         pfo_piddedx_eprob[10000];   //[pfo_n]
   Float_t         pfo_piddedx_muprob[10000];   //[pfo_n]
   Float_t         pfo_piddedx_piprob[10000];   //[pfo_n]
   Float_t         pfo_piddedx_kprob[10000];   //[pfo_n]
   Float_t         pfo_piddedx_pprob[10000];   //[pfo_n]
   Float_t         pfo_piddedx_hprob[10000];   //[pfo_n]
   Float_t         pfo_piddedx_e_dedxdist[10000];   //[pfo_n]
   Float_t         pfo_piddedx_mu_dedxdist[10000];   //[pfo_n]
   Float_t         pfo_piddedx_pi_dedxdist[10000];   //[pfo_n]
   Float_t         pfo_piddedx_k_dedxdist[10000];   //[pfo_n]
   Float_t         pfo_piddedx_p_dedxdist[10000];   //[pfo_n]
   Float_t         pfo_piddedx_e_lkhood[10000];   //[pfo_n]
   Float_t         pfo_piddedx_mu_lkhood[10000];   //[pfo_n]
   Float_t         pfo_piddedx_pi_lkhood[10000];   //[pfo_n]
   Float_t         pfo_piddedx_k_lkhood[10000];   //[pfo_n]
   Float_t         pfo_piddedx_p_lkhood[10000];   //[pfo_n]
