...
void JetTag(int cut,TString kvalue, TString cat, TString quality) {
  ...
  TString filename = "../results/jettag_"+cutname+"_2f_hadronic_sample_"+cat+"_BDT_"+quality+"_eL_pR_Kgamma"+kvalue+"_250GeV.root";
  ...
  TString filename2 = "../results/jettag_"+cutname+"_2f_hadronic_sample_"+cat+"_BDT_"+quality+"_eR_pL_Kgamma"+kvalue+"_250GeV.root";
